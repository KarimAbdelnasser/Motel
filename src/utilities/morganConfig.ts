...
type MorganFormatFunction = (
    req: Request,
    res: Response,
    next: NextFunction
) => void;

export const morganMiddleware: MorganFormatFunction = (req, res, next) => {
    ...
    res.on("finish", () => {
        ...
        const durationInMs = calculateResponseTime(start);
...
function calculateResponseTime(start: [number, number]): number {
